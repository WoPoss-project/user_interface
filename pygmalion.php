...
<main>
    ...
    <p>Pygmalion is an intuitive tool conceived to draw and visualise interactive diachronic semantic maps. <a
                href="http://woposs.unil.ch/pygmalion-simple.php" target="_blank">Pygmalion-simple
            1.0</a> is thought to draw any type of diachronic semantic map, while <a
                href="http://woposs.unil.ch/pygmalion-form.php" target="_blank">Pygmalion-modal 1.0</a> is
    ...
    <p>Once a user has created a map, s/he can export the data in JSON format through the ‘Export data map’ button’
        ...
        the ‘Import map data’ button. Map data can be imported from <a href="http://woposs.unil.ch/map.php" target="_blank">this address</a>.</p>
</main>
