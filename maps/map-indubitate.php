...
<head>
    <title>Diachronic Visualisation: INDUBITATE - WoPoss</title>
    ...
    <script src="../js/json/indubitate.js">/**/</script>
...
<main>
    <h1>Diachronic modal semantic map of INDUBITATE</h1>

    <p>See related diachronic semantic maps:</p>
    <ul>
        <li><a href="map-indubitate.php" target="_blank">INDUBITATO</a></li>
        <li><a href="map-indubitato.php" target="_blank">INDUBITATUS</a></li>
    </ul>
    ...
    <div>
        ...
        <ul>
            <li>Marongiu, Paola; Dell‘Oro, Francesca (2021). “<a
                        ...
                        target="_blank">indubitate</a>”. v.1.0. WoPoss. <a
                        href="https://woposs.unine.ch/maps/map-indubitate.php">https://woposs.unine.ch/maps/map-indubitate.php</a>
            </li>
        </ul>
    </div>
