...
<head>
    <title>Diachronic Visualisation: POSSUM - WoPoss</title>
    ...
    <script src="../js/json/possum.js">/**/</script>
...
<main>
    <h1>Diachronic modal semantic map of POSSUM</h1>
    ...
    <div>
        ...
        <ul>
            <li>Marongiu, Paola; Dell‘Oro, Francesca (2021). “<a
                        href="maps/map-possum.php"
                        target="_blank">possum</a>”. v.1.0. WoPoss. <a
                        href="https://woposs.unine.ch/maps/map-possum.php">https://woposs.unine.ch/maps/map-possum.php</a>
            </li>
        </ul>
    </div>
