...
<head>
    ...
    <script src="../js/json/inique.js">/**/</script>
    ...
    <div>
        ...
        <ul>
            <li>Marongiu, Paola; Dell‘Oro, Francesca (2021). “<a
                        href="maps/map-inique.php"
                        target="_blank">inique</a>”. v.1.0. WoPoss. <a
                        href="https://woposs.unine.ch/maps/map-inique.php">https://woposs.unine.ch/maps/map-inique.php</a>
            </li>
        </ul>
    </div>
