...
<head>
    <title>Diachronic Visualisation: DUBIUS - WoPoss</title>
    ...
    <script src="../js/json/dubius.js">/**/</script>
...
<main>
    <h1>Diachronic modal semantic map of DUBIUS</h1>
    ...
    <div>
        ...
        <ul>
            <li>Marongiu, Paola; Dell‘Oro, Francesca (2021). “<a
                        href="maps/map-dubius.php"
                        target="_blank">dubius</a>”. v.1.0. WoPoss. <a
                        href="https://woposs.unine.ch/maps/map-incerte.php">https://woposs.unine.ch/maps/map-dubius.php</a>
            </li>
        </ul>
    </div>
