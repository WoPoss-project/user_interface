...
<head>
    <title>Diachronic Visualisation: APTE - WoPoss</title>
    ...
    <script src="../js/json/apte.js">/**/</script>
...
<main>
    <h1>Diachronic semantic map of APTE</h1>
    <ul>
        <li><a href="map-apte.php" target="_blank">APTUS</a></li>
    </ul>
    ...
    <div>
        ...
        <ul>
            <li>Marongiu, Paola; Dell‘Oro, Francesca (2021). “<a
                        href="maps/map-apte.php"
                        target="_blank">apte</a>”. v.1.0. WoPoss. <a
                        href="https://woposs.unine.ch/maps/map-apte.php">https://woposs.unine.ch/maps/map-apte.php</a>
            </li>
        </ul>
    </div>
