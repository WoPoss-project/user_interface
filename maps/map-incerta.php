...
<head>
    <title>Diachronic Visualisation: INCERTA - WoPoss</title>
    ...
    <script src="../js/json/incerta.js">/**/</script>
    ...
    <div>
        ...
        <ul>
            <li>Marongiu, Paola; Dell‘Oro, Francesca (2021). “<a
                        ...
                        href="https://woposs.unine.ch/maps/map-incerta.php">https://woposs.unine.ch/maps/map-incerta.php</a>
            </li>
        </ul>
    </div>
