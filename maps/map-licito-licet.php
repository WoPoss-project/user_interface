...
<head>
    <title>Diachronic Visualisation: LICITO - WoPoss</title>
    ...
    <script src="../js/json/licito_licet.js">/**/</script>
...
<main>
    <h1>Diachronic modal map of LICITO</h1>
    ...
    <div>
        ...
        <ul>
            <li>Marongiu, Paola; Dell‘Oro, Francesca (2021). “<a
                        href="maps/map-licito-licet.php"
                        target="_blank">licito</a>”. v.1.0. WoPoss. <a
                        href="https://woposs.unine.ch/maps/map-licito-licet.php">https://woposs.unine.ch/maps/map-licito-licet.php</a>
            </li>
        </ul>
    </div>
