...
<head>
    <title>Diachronic Visualisation: POTIOR - WoPoss</title>
    ...
    <script src="../js/json/potior.js">/**/</script>
...
<main>
    <h1>Diachronic modal semantic map of POTIOR</h1>
    ...
    <div>
        ...
        <ul>
            <li>Marongiu, Paola; Dell‘Oro, Francesca (2021). “<a
                        ...
                        target="_blank">potior</a>”. v.1.0. WoPoss. <a
                        href="https://woposs.unine.ch/maps/map-potior.php">https://woposs.unine.ch/maps/map-potior.php</a>
            </li>
        </ul>
    </div>
