...
<head>
    <title>Diachronic Visualisation: DECENTER - WoPoss</title>
...
<main>
    <h1>Diachronic map of DECENTER</h1>
    <ul>
    ...
    <div>
        ...
        <ul>
            <li>Marongiu, Paola; Dell‘Oro, Francesca (2021). “<a
                        href="maps/map-decenter.php"
                        target="_blank">decenter</a>”. v.1.0. WoPoss. <a
                        href="https://woposs.unine.ch/maps/map-decenter.php">https://woposs.unine.ch/maps/map-decenter.php</a>
            </li>
        </ul>
    </div>
