...
<head>
    <title>Diachronic Visualisation: DECET - WoPoss</title>
    ...
    <script src="../js/json/decet.js">/**/</script>
...
<main>
    <h1>Diachronic semantic map of DECET</h1>
    <ul>
        <li><a href="map-decens.php" target="_blank">DECENS</a></li>
    ...
    <div>
        ...
        <ul>
            <li>Marongiu, Paola; Dell‘Oro, Francesca (2021). “<a
                        href="maps/map-decet.php"
                        target="_blank">decet</a>”. v.1.0. WoPoss. <a
                        href="https://woposs.unine.ch/maps/map-decet.php">https://woposs.unine.ch/maps/map-decet.php</a>
            </li>
        </ul>
    </div>
