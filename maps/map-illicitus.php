...
<head>
    <title>Diachronic Visualisation: ILLICITUS - WoPoss</title>
    ...
    <script src="../js/json/illicitus.js">/**/</script>
...
<main>
    <h1>Diachronic modal semantic map of ILLICITUS</h1>

    <p>See related diachronic semantic maps:</p>
    <ul>
        <li><a href="map-illicite.php" target="_blank">ILLICITE</a></li>
        <li><a href="map-illicito.php" target="_blank">ILLICITO</a></li>
    ...
    <div>
        ...
        <ul>
            <li>Marongiu, Paola; Dell‘Oro, Francesca (2021). “<a
                        href="maps/map-illicitus.php"
                        target="_blank">illicitus</a>”. v.1.0. WoPoss. <a
                        href="https://woposs.unine.ch/maps/map-illicitus.php">https://woposs.unine.ch/maps/map-illicitus.php</a>
            </li>
        </ul>
    </div>
