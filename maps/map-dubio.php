...
<head>
    <title>Diachronic Visualisation: DUBIO - WoPoss</title>
    ...
    <script src="../js/json/dubio.js">/**/</script>
    ...
    <div>
        ...
        <ul>
            <li>Marongiu, Paola; Dell‘Oro, Francesca (2021). “<a
                        href="maps/map-dubio.php"
                        target="_blank">dubio</a>”. v.1.0. WoPoss. <a
                        href="https://woposs.unine.ch/maps/map-dubio.php">https://woposs.unine.ch/maps/map-dubio.php</a>
            </li>
        </ul>
    </div>
