...
<head>
    <title>Diachronic Visualisation: NECESSITUDO - WoPoss</title>
    ...
    <script src="../js/json/necessitudo.js">/**/</script>
...
<main>
    <h1>Diachronic modal semantic map of NECESSITUDO</h1>
    ...
    <div>
        ...
        <ul>
            <li>Marongiu, Paola; Dell‘Oro, Francesca (2021). “<a
                        ...
                        href="https://woposs.unine.ch/maps/map-necessitudo.php">https://woposs.unine.ch/maps/map-necessitudo.php</a>
            </li>
        </ul>
    </div>
