...
<head>
    <title>Diachronic Visualisation: INCERTUS - WoPoss</title>
    ...
    <script src="../js/json/incertus_adj.js">/**/</script>
...
<main>
    <h1>Diachronic modal semantic map of INCERTUS (adjective)</h1>

    <p>See related diachronic semantic maps:</p>
    <ul>
        <li><a href="map-incerta.php" target="_blank">INCERTA</a></li>
        <li><a href="map-incerte.php" target="_blank">INCERTE</a></li>
        <li><a href="map-incertim.php" target="_blank">INCERTIM</a></li>
        <li><a href="map-incertum.php" target="_blank">INCERTUM</a> (noun)</li>
    </ul>
    ...
    <div>
        ...
        <ul>
            <li>Marongiu, Paola; Dell‘Oro, Francesca (2021). “<a
                        href="maps/map-incertus.php"
                        target="_blank">incertus</a>”. v.1.0. WoPoss. <a
                        href="https://woposs.unine.ch/maps/map-incertus.php">https://woposs.unine.ch/maps/map-incertus.php</a>
            </li>
        </ul>
    </div>
