...
<head>
    <title>Diachronic Visualisation: POTISSIMUS - WoPoss</title>
    ...
    <script src="../js/json/potissimus.js">/**/</script>
...
<main>
    <h1>Diachronic modal semantic map of POTISSIMUS</h1>
    ...
    <ul>
        ...
        <li><a href="map-potissimum.php" target="_blank">POTISSIMUM</a></li>
    ...
    <div>
        ...
        <ul>
            <li>Marongiu, Paola; Dell‘Oro, Francesca (2021). “<a
                        ...
                        target="_blank">potissimus</a>”. v.1.0. WoPoss. <a
                        href="https://woposs.unine.ch/maps/map-potissimus.php">https://woposs.unine.ch/maps/map-potissimus.php</a>
            </li>
        </ul>
    </div>
