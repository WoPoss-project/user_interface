...
<head>
    <title>Diachronic Visualisation: POTE - WoPoss</title>
    ...
    <script src="../js/json/pote.js">/**/</script>
...
<main>
    <h1>Diachronic modal semantic map of POTE</h1>
    ...
    <div>
        ...
        <ul>
            <li>Marongiu, Paola; Dell‘Oro, Francesca (2021). “<a
                        ...
                        target="_blank">pote</a>”. v.1.0. WoPoss. <a
                        href="https://woposs.unine.ch/maps/map-pote.php">https://woposs.unine.ch/maps/map-pote.php</a>
            </li>
        </ul>
    </div>
