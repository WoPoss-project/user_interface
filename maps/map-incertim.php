...
<head>
    <title>Diachronic Visualisation: INCERTIM - WoPoss</title>
...
<main>
    <h1>Diachronic modal semantic map of INCERTIM</h1>
    ...
    <div>
        ...
        <ul>
            <li>Marongiu, Paola; Dell‘Oro, Francesca (2021). “<a
                        href="maps/map-incertim.php"
                        target="_blank">incertim</a>”. v.1.0. WoPoss. <a
                        href="https://woposs.unine.ch/maps/map-incertim.php">https://woposs.unine.ch/maps/map-incertim.php</a>
            </li>
        </ul>
    </div>
