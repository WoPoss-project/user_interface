...
<head>
    <title>Diachronic Visualisation: ILLICITE - WoPoss</title>
    ...
    <script src="../js/json/illicite.js">/**/</script>
...
<main>
    <h1>Diachronic modal semantic map of ILLICITE</h1>
    ...
    <div>
        ...
        <ul>
            <li>Marongiu, Paola; Dell‘Oro, Francesca (2021). “<a
                        href="maps/map-illicite.php"
                        target="_blank">illicite</a>”. v.1.0. WoPoss. <a
                        href="https://woposs.unine.ch/maps/map-illicite.php">https://woposs.unine.ch/maps/map-illicite.php</a>
            </li>
        </ul>
    </div>
