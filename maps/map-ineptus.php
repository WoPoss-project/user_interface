...
<head>
    <title>Diachronic Visualisation: INEPTUS - WoPoss</title>
    ...
    <script src="../js/json/ineptus.js">/**/</script>
...
<main>
    <h1>Diachronic modal semantic map of INEPTUS</h1>
    ...
    <div>
        ...
        <ul>
            <li>Marongiu, Paola; Dell‘Oro, Francesca (2021). “<a
                        ...
                        target="_blank">ineptus</a>”. v.1.0. WoPoss. <a
                        href="https://woposs.unine.ch/maps/map-ineptus.php">https://woposs.unine.ch/maps/map-ineptus.php</a>
            </li>
        </ul>
    </div>
