...
<head>
    <title>Diachronic Visualisation: POTIS - WoPoss</title>
    ...
    <script src="../js/json/potis.js">/**/</script>
...
<main>
    <h1>Diachronic modal semantic map of POTIS</h1>
    ...
    <div>
        ...
        <ul>
            <li>Marongiu, Paola; Dell‘Oro, Francesca (2021). “<a
                        href="maps/map-potis.php"
                        target="_blank">potis</a>”. v.1.0. WoPoss. <a
                        href="https://woposs.unine.ch/maps/map-potis.php">https://woposs.unine.ch/maps/map-potis.php</a>
            </li>
        </ul>
    </div>
