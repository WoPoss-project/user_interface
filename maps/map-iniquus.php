...
<head>
    <title>Diachronic Visualisation: INIQUUS - WoPoss</title>
    ...
    <script src="../js/json/iniquus.js">/**/</script>
    ...
    <div>
        ...
        <ul>
            <li>Marongiu, Paola; Dell‘Oro, Francesca (2021). “<a
                        href="maps/map-iniquus.php"
                        target="_blank">iniquus</a>”. v.1.0. WoPoss. <a
                        href="https://woposs.unine.ch/maps/map-iniquus.php">https://woposs.unine.ch/maps/map-iniquus.php</a>
            </li>
        </ul>
    </div>
