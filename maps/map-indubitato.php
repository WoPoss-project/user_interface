...
<head>
    <title>Diachronic Visualisation: INDUBITATO - WoPoss</title>
    ...
    <script src="../js/json/indubitato.js">/**/</script>
...
<main>
    <h1>Diachronic modal semantic map of INDUBITATO</h1>

    <p>See related diachronic semantic maps:</p>
    <ul>
        <li><a href="map-indubitate.php" target="_blank">INDUBITATE</a></li>
        <li><a href="map-indubitatus.php" target="_blank">INDUBITATUS</a></li>
    ...
    <div>
        ...
        <ul>
            <li>Marongiu, Paola; Dell‘Oro, Francesca (2021). “<a
                        ...
                        target="_blank">indubitato</a>”. v.1.0. WoPoss. <a
                        href="https://woposs.unine.ch/maps/map-indubitato.php">https://woposs.unine.ch/maps/map-indubitato.php</a>
            </li>
        </ul>
    </div>
