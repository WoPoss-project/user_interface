...
<head>
    <title>Diachronic Visualisation: OPUS - WoPoss</title>
    ...
    <script src="../js/json/opus.js">/**/</script>
...
<main>
    <h1>Diachronic modal semantic map of OPUS</h1>
    ...
    <div>
        ...
        <ul>
            <li>Marongiu, Paola; Dell‘Oro, Francesca (2021). “<a
                        href="maps/map-opus.php"
                        target="_blank">opus</a>”. v.1.0. WoPoss. <a
                        href="https://woposs.unine.ch/maps/map-opus.php">https://woposs.unine.ch/maps/map-opus.php</a>
            </li>
        </ul>
    </div>
