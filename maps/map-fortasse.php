...
<head>
    <title>Diachronic Visualisation: FORTASSE - WoPoss</title>
    ...
    <script src="../js/json/fortasse.js">/**/</script>
...
<main>
    <h1>Diachronic modal semantic map of FORTASSE</h1>
    ...
    <div>
        ...
        <ul>
            <li>Marongiu, Paola; Dell‘Oro, Francesca (2021). “<a
                        href="maps/map-fortasse.php"
                        target="_blank">fortasse</a>”. v.1.0. WoPoss. <a
                        href="https://woposs.unine.ch/maps/map-fortasse.php">https://woposs.unine.ch/maps/map-fortasse.php</a>
            </li>
        </ul>
    </div>
