...
<head>
    <title>Diachronic Visualisation: DECENS - WoPoss</title>
    ...
    <script src="../js/json/decens.js">/**/</script>
    ...
    <div>
        ...
        <ul>
            <li>Marongiu, Paola; Dell‘Oro, Francesca (2021). “<a
                        href="maps/map-decens.php"
                        target="_blank">decens</a>”. v.1.0. WoPoss. <a
                        href="https://woposs.unine.ch/maps/map-decens.php">https://woposs.unine.ch/maps/map-decens.php</a>
            </li>
        </ul>
    </div>
