...
<head>
    <title>Diachronic Visualisation: LICITUS - WoPoss</title>
    ...
    <script src="../js/json/licitus.js">/**/</script>
    ...
    <div>
        ...
        <ul>
            <li>Marongiu, Paola; Dell‘Oro, Francesca (2021). “<a
                        href="maps/map-licitus.php"
                        target="_blank">licitus</a>”. v.1.0. WoPoss. <a
                        href="https://woposs.unine.ch/maps/map-licitus.php">https://woposs.unine.ch/maps/map-licitus.php</a>
            </li>
        </ul>
    </div>
