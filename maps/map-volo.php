...
<head>
    <title>Diachronic Visualisation: VOLO - WoPoss</title>
...
<main>
    <h1>Diachronic modal map of VOLO</h1>
    ...
    <div>
        ...
        <ul>
            <li>Marongiu, Paola; Dell‘Oro, Francesca (2021). “<a
                        href="maps/map-volo.php"
                        target="_blank">volo</a>”. v.1.0. WoPoss. <a
                        href="https://woposs.unine.ch/maps/map-volo.php">https://woposs.unine.ch/maps/map-volo.php</a>
            </li>
        </ul>
    </div>
