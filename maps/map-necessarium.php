...
<head>
    <title>Diachronic Visualisation: NECESSARIUM - WoPoss</title>
    ...
    <script src="../js/json/necessarium.js">/**/</script>
...
<main>
    <h1>Diachronic modal semantic map of NECESSARIUM</h1>

    <p>See related diachronic semantic maps:</p>
    <ul>
        <li><a href="map-necessarie.php" target="_blank">NECESSARIE</a></li>
    ...
    <div>
        ...
        <ul>
            <li>Marongiu, Paola; Dell‘Oro, Francesca (2021). “<a
                        href="maps/map-necessarium.php"
                        target="_blank">necessarium</a>”. v.1.0. WoPoss. <a
                        href="https://woposs.unine.ch/maps/map-necessarium.php">https://woposs.unine.ch/maps/map-necessarium.php</a>
            </li>
        </ul>
    </div>
