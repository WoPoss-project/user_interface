...
<head>
    <title>Diachronic Visualisation: IUS - WoPoss</title>
    ...
    <script src="../js/json/ius.js">/**/</script>
...
<main>
    <h1>Diachronic modal semantic map of IUS</h1>
    ...
    <div>
        ...
        <ul>
            <li>Marongiu, Paola; Dell‘Oro, Francesca (2021). “<a
                        ...
                        target="_blank">ius</a>”. v.1.0. WoPoss. <a
                        href="https://woposs.unine.ch/maps/map-ius.php">https://woposs.unine.ch/maps/map-ius.php</a>
            </li>
        </ul>
    </div>
