...
<head>
    ...
    <script src="../js/json/licite.js">/**/</script>
...
<main>
    ...
    <ul>
        ...
        <li><a href="map-licito.php" target="_blank">LICITO</a></li>
        <li><a href="map-licitus.php" target="_blank">LICITUS</a></li>
    </ul>
    ...
    <div>
        ...
        <ul>
            <li>Marongiu, Paola; Dell‘Oro, Francesca (2021). “<a
                        href="maps/map-licite.php"
                        target="_blank">licite</a>”. v.1.0. WoPoss. <a
                        href="https://woposs.unine.ch/maps/map-licite.php">https://woposs.unine.ch/maps/map-licite.php</a>
            </li>
        </ul>
    </div>
