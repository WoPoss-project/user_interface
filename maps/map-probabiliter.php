...
<head>
    <title>Diachronic Visualisation: PROBABILITER - WoPoss</title>
    ...
    <script src="../js/json/probabiliter.js">/**/</script>
...
<main>
    <h1>Diachronic modal map of PROBABILITER</h1>

    <p>See related diachronic semantic map:</p>
    <ul>
        <li><a href="map-probabilis.php" target="_blank">PROBABILIS</a></li>
    </ul>
    ...
    <div>
        ...
        <ul>
            <li>Marongiu, Paola; Dell‘Oro, Francesca (2021). “<a
                        href="maps/map-probabiliter.php"
                        target="_blank">probabiliter</a>”. v.1.0. WoPoss. <a
                        href="https://woposs.unine.ch/maps/map-probabiliter.php">https://woposs.unine.ch/maps/map-probabiliter.php</a>
            </li>
        </ul>
    </div>
