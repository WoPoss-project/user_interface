...
<head>
    <title>Diachronic Visualisation: VALEO - WoPoss</title>
    ...
    <script src="../js/json/valeo.js">/**/</script>
...
<main>
    <h1>Diachronic modal semantic map of VALEO</h1>
    ...
    <div>
        ...
        <ul>
            <li>Marongiu, Paola; Dell‘Oro, Francesca (2021). “<a
                        ...
                        target="_blank">valeo</a>”. v.1.0. WoPoss. <a
                        href="https://woposs.unine.ch/maps/map-valeo.php">https://woposs.unine.ch/maps/map-valeo.php</a>
            </li>
        </ul>
    </div>
