...
<head>
    <title>Diachronic Visualisation: INDUBITANS - WoPoss</title>
    ...
    <script src="../js/json/indubitans.js">/**/</script>
    ...
    <div>
        ...
        <ul>
            <li>Marongiu, Paola; Dell‘Oro, Francesca (2021). “<a
                        href="maps/map-indubitans.php"
                        target="_blank">indubitans</a>”. v.1.0. WoPoss. <a
                        href="https://woposs.unine.ch/maps/map-indubitans.php">https://woposs.unine.ch/maps/map-indubitans.php</a>
            </li>
        </ul>
    </div>
