...
<head>
    <title>Diachronic Visualisation: NECESSE - WoPoss</title>
    ...
    <script src="../js/json/necesse.js">/**/</script>
...
<main>
    <h1>Diachronic modal semantic map of NECESSE</h1>
    ...
    <div>
        ...
        <ul>
            <li>Marongiu, Paola; Dell‘Oro, Francesca (2021). “<a
                        href="maps/map-necesse.php"
                        target="_blank">necesse</a>”. v.1.0. WoPoss. <a
                        href="https://woposs.unine.ch/maps/map-necesse.php">https://woposs.unine.ch/maps/map-necesse.php</a>
            </li>
        </ul>
    </div>
