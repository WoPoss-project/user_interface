...
<head>
    <title>Diachronic Visualisation: POSSIBILIS - WoPoss</title>
    ...
    <script src="../js/json/possibilis.js">/**/</script>
...
<main>
    <h1>Diachronic modal semantic map of POSSIBILIS</h1>
    <p>See related diachronic semantic map:</p>
    <ul>
        <li><a href="map-possibiliter.php" target="_blank">POSSIBILITER</a></li>
    </ul>
    ...
    <div>
        ...
        <ul>
            <li>Marongiu, Paola; Dell‘Oro, Francesca (2021). “<a
                        href="maps/map-possibilis.php"
                        target="_blank">possibilis</a>”. v.1.0. WoPoss. <a
                        href="https://woposs.unine.ch/maps/map-possibilis.php">https://woposs.unine.ch/maps/map-possibilis.php</a>
            </li>
        </ul>
    </div>
