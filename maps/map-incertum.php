...
<head>
    <title>Diachronic Visualisation: INCERTUM - WoPoss</title>
    ...
    <script src="../js/json/incertum_noun.js">/**/</script>
...
<main>
    <h1>Diachronic modal semantic map of INCERTUM (noun)</h1>
    ...
    <div>
        ...
        <ul>
            <li>Marongiu, Paola; Dell‘Oro, Francesca (2021). “<a
                        href="maps/map-incertum.php"
                        target="_blank">incertum</a>”. v.1.0. WoPoss. <a
                        href="https://woposs.unine.ch/maps/map-incertum.php">https://woposs.unine.ch/maps/map-incertum.php</a>
            </li>
        </ul>
    </div>
