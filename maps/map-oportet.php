...
<head>
    <title>Diachronic Visualisation: OPORTET - WoPoss</title>
    ...
    <script src="../js/json/oportet.js">/**/</script>
...
<main>
    <h1>Diachronic modal semantic map of OPORTET</h1>
    ...
    <div>
        ...
        <ul>
            <li>Marongiu, Paola; Dell‘Oro, Francesca (2021). “<a
                        href="maps/map-oportet.php"
                        target="_blank">oportet</a>”. v.1.0. WoPoss. <a
                        href="https://woposs.unine.ch/maps/map-oportet.php">https://woposs.unine.ch/maps/map-oportet.php</a>
            </li>
        </ul>
    </div>
