...
<head>
    <title>Diachronic Visualisation: NECESSARIO - WoPoss</title>
    ...
    <script src="../js/json/necessario.js">/**/</script>
...
<main>
    <h1>Diachronic modal semantic map of NECESSARIO</h1>
    ...
    <div>
        ...
        <ul>
            <li>Marongiu, Paola; Dell‘Oro, Francesca (2021). “<a
                        href="maps/map-necessario.php"
                        target="_blank">necessario</a>”. v.1.0. WoPoss. <a
                        href="https://woposs.unine.ch/maps/map-necessario.php">https://woposs.unine.ch/maps/map-necessario.php</a>
            </li>
        </ul>
    </div>
