...
<head>
    <title>Diachronic Visualisation: NOLO - WoPoss</title>
    ...
    <script src="../js/json/nolo.js">/**/</script>
...
<main>
    <h1>Diachronic modal semantic map of NOLO</h1>
    ...
    <div>
        ...
        <ul>
            <li>Marongiu, Paola; Dell‘Oro, Francesca (2021). “<a
                        href="maps/map-nolo.php"
                        target="_blank">nolo</a>”. v.1.0. WoPoss. <a
                        href="https://woposs.unine.ch/maps/map-nolo.php">https://woposs.unine.ch/maps/map-nolo.php</a>
            </li>
        </ul>
    </div>
