...
<head>
    <title>Diachronic Visualisation: INDUBITANTER - WoPoss</title>
    ...
    <script src="../js/json/indubitanter.js">/**/</script>
...
<main>
    <h1>Diachronic modal semantic map of INDUBITANTER</h1>

    <p>See related diachronic semantic maps:</p>
    <ul>
        <li><a href="map-indubitans.php" target="_blank">INDUBITANS</a></li>
        \
    </ul>
    ...
    <div>
        ...
        <ul>
            <li>Marongiu, Paola; Dell‘Oro, Francesca (2021). “<a
                        ...
                        target="_blank">indubitanter</a>”. v.1.0. WoPoss. <a
                        href="https://woposs.unine.ch/maps/map-indubitanter.php">https://woposs.unine.ch/maps/map-indubitanter.php</a>
            </li>
        </ul>
    </div>
