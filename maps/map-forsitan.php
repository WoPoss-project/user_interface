...
<head>
    <title>Diachronic Visualisation: FORSITAN - WoPoss</title>
    ...
    <script src="../js/json/forsitan.js">/**/</script>
    ...
    <div>
        ...
        <ul>
            <li>Marongiu, Paola; Dell‘Oro, Francesca (2021). “<a
                        href="maps/map-forsitan.php"
                        target="_blank">forsitan</a>”. v.1.0. WoPoss. <a
                        href="https://woposs.unine.ch/maps/map-forsitan.php">https://woposs.unine.ch/maps/map-forsitan.php</a>
            </li>
        </ul>
    </div>
