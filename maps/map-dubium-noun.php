...
<head>
    <title>Diachronic Visualisation: DUBIUM (noun) - WoPoss</title>
    ...
    <script src="../js/json/dubium_noun.js">/**/</script>
...
<main>
    <h1>Diachronic modal semantic map of DUBIUM (noun)</h1>
    ...
    <div>
        ...
        <ul>
            <li>Marongiu, Paola; Dell‘Oro, Francesca (2021). “<a
                        href="maps/map-dubium-noun.php"
                        target="_blank">dubium</a> (noun)”. v.1.0. WoPoss. <a
                        href="https://woposs.unine.ch/maps/map-dubium-noun.php">https://woposs.unine.ch/maps/map-dubium-noun.php</a>
            </li>
        </ul>
    </div>
