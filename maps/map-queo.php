...
<head>
    <title>Diachronic Visualisation: QUEO - WoPoss</title>
    ...
    <script src="../js/json/queo.js">/**/</script>
...
<main>
    <h1>Diachronic modal semantic map of QUEO</h1>
    ...
    <div>
        ...
        <div class="top">
            <h3>Sources</h3>
            <ul>                <li>Ernout, Alfred &amp; Antoine Meillet (1932). <em>Dictionnaire étymologique de la langue latine:
        ...
        <ul>
            <li>Marongiu, Paola; Dell‘Oro, Francesca (2021). “<a
                        href="maps/map-queo.php"
                        target="_blank">queo</a>”. v.1.0. WoPoss. <a
                        href="https://woposs.unine.ch/maps/map-queo.php">https://woposs.unine.ch/maps/map-queo.php</a>
            </li>
        </ul>
    </div>
