...
<head>
    <title>Diachronic Visualisation: INDUBITATUS - WoPoss</title>
    ...
    <script src="../js/json/indubitatus.js">/**/</script>
    ...
    <div>
        ...
        <ul>
            <li>Marongiu, Paola; Dell‘Oro, Francesca (2021). “<a
                        ...
                        href="https://woposs.unine.ch/maps/map-indubitatus.php">https://woposs.unine.ch/maps/map-indubitatus.php</a>
            </li>
        </ul>
    </div>
