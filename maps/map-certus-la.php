...
<main>
    <h1>Diachronic modal map of CERTUS</h1>
    ...
    <div>
        ...
        <ul>
            <li>Marongiu, Paola; Bermúdez Sabel, Helena; Dell‘Oro, Francesca (2021). “<a
                        href="maps/map-certus-la.php"
                        target="_blank">certus</a> (monolingual)”. v.1.0. WoPoss. <a
                        href="https://woposs.unine.ch/maps/map-certus-la.php">https://woposs.unine.ch/maps/map-certus-la.php</a>
            </li>
        </ul>
    </div>
