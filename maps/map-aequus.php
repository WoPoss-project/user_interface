...
<head>
    <title>Diachronic Visualisation: AEQUUS - WoPoss</title>
...
<main>
    <h1>Diachronic modal map of AEQUUS</h1>
    ...
    <div>
        ...
        <ul>
            <li>Marongiu, Paola; Dell‘Oro, Francesca (2021). “<a
                        ...
                        target="_blank">aequus</a>”. v.1.0. WoPoss. <a
                        href="https://woposs.unine.ch/maps/map-aequus.php">https://woposs.unine.ch/maps/map-aequus.php</a>
            </li>
        </ul>
    </div>
