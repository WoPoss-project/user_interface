...
<head>
    <title>Diachronic Visualisation: DUBIE - WoPoss</title>
...
<main>
    <h1>Diachronic modal map of DUBIE</h1>
    ...
    <div>
        ...
        <ul>
            <li>Marongiu, Paola; Dell‘Oro, Francesca (2021). “<a
                        href="maps/map-dubie.php"
                        target="_blank">dubie</a>”. v.1.0. WoPoss. <a
                        href="https://woposs.unine.ch/maps/map-dubie.php">https://woposs.unine.ch/maps/map-dubie.php</a>
            </li>
        </ul>
    </div>
