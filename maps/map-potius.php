...
<head>
    <title>Diachronic Visualisation: POTIUS - WoPoss</title>
    ...
    <script src="../js/json/potius.js">/**/</script>
...
<main>
    <h1>Diachronic modal semantic map of POTIUS</h1>
    ...
    <div>
        ...
        <ul>
            <li>Marongiu, Paola; Dell‘Oro, Francesca (2021). “<a
                        ...
                        target="_blank">potius</a>”. v.1.0. WoPoss. <a
                        href="https://woposs.unine.ch/maps/map-potius.php">https://woposs.unine.ch/maps/map-potius.php</a>
            </li>
        </ul>
    </div>
