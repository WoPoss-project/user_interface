...
<head>
    <title>Diachronic Visualisation: USUS - WoPoss</title>
    ...
    <script src="../js/json/usus.js">/**/</script>
...
<main>
    <h1>Diachronic modal semantic map of USUS</h1>
    ...
    <div>
        ...
        <div class="top">
            ...
            <ul>
                ...
                </li><li>Michiel de Vaan (2011). <em>Etymological Dictionary of Latin</em>. Leiden: Brill.</li>
                </li>
        ...
        <ul>
            <li>Marongiu, Paola; Dell‘Oro, Francesca (2021). “<a
                        href="maps/map-usus.php"
                        target="_blank">usus</a>”. v.1.0. WoPoss. <a
                        href="https://woposs.unine.ch/maps/map-usus.php">https://woposs.unine.ch/maps/map-usus.php</a>
            </li>
        </ul>
    </div>
