...
<head>
    <title>Diachronic Visualisation: NECESSARIE - WoPoss</title>
    ...
    <div>
        ...
        <ul>
            <li>Marongiu, Paola; Dell‘Oro, Francesca (2021). “<a
                        href="maps/map-necessarie.php"
                        target="_blank">necessarie</a>”. v.1.0. WoPoss. <a
                        href="https://woposs.unine.ch/maps/map-necessarie.php">https://woposs.unine.ch/maps/map-necessarie.php</a>
            </li>
        </ul>
    </div>
