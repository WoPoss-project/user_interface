...
<head>
    <title>Diachronic Visualisation: POTESTAS - WoPoss</title>
    ...
    <script src="../js/json/potestas.js">/**/</script>
...
<main>
    <h1>Diachronic modal semantic map of POTESTAS</h1>
    ...
    <div>
        ...
        <ul>
            <li>Marongiu, Paola; Dell‘Oro, Francesca (2021). “<a
                        href="maps/map-potestas.php"
                        target="_blank">potestas</a>”. v.1.0. WoPoss. <a
                        href="https://woposs.unine.ch/maps/map-potestas.php">https://woposs.unine.ch/maps/map-potestas.php</a>
            </li>
        </ul>
    </div>
