...
<head>
    <title>Diachronic Visualisation: ILLICITO - WoPoss</title>
    ...
    <script src="../js/json/illicito.js">/**/</script>
...
<main>
    <h1>Diachronic modal map of ILLICITO</h1>
    ...
    <div>
        ...
        <ul>
            <li>Marongiu, Paola; Dell‘Oro, Francesca (2021). “<a
                        href="maps/map-illicito.php"
                        target="_blank">illicito</a>”. v.1.0. WoPoss. <a
                        href="https://woposs.unine.ch/maps/map-illicito.php">https://woposs.unine.ch/maps/map-illicito.php</a>
            </li>
        </ul>
    </div>
