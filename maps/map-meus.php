...
<head>
    <title>Diachronic Visualisation: MEUS - WoPoss</title>
    ...
    <script src="../js/json/meus.js">/**/</script>
...
<main>
    <h1>Diachronic modal semantic map of MEUS</h1>
    ...
    <div>
        ...
        <ul>
            <li>Marongiu, Paola; Dell‘Oro, Francesca (2021). “<a
                        href="maps/map-meus.php"
                        target="_blank">meus</a>”. v.1.0. WoPoss. <a
                        href="https://woposs.unine.ch/maps/map-meus.php">https://woposs.unine.ch/maps/map-meus.php</a>
            </li>
        </ul>
    </div>
