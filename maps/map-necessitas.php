...
<head>
    <title>Diachronic Visualisation: NECESSITAS - WoPoss</title>
    ...
    <script src="../js/json/necessitas.js">/**/</script>
...
<main>
    <h1>Diachronic modal semantic map of NECESSITAS</h1>
    ...
    <div>
        ...
        <ul>
            <li>Marongiu, Paola; Dell‘Oro, Francesca (2021). “<a
                        href="maps/map-necessitas.php"
                        target="_blank">necessitas</a>”. v.1.0. WoPoss. <a
                        href="https://woposs.unine.ch/maps/map-necessitas.php">https://woposs.unine.ch/maps/map-necessitas.php</a>
            </li>
        </ul>
    </div>
