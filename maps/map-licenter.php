...
<head>
    <title>Diachronic Visualisation: LICENTER - WoPoss</title>
    ...
    <script src="../js/json/licenter_licet.js">/**/</script>
...
<main>
    <h1>Diachronic modal semantic map of LICENTER</h1>

    <p>See related diachronic semantic maps:</p>
    <ul>
        <li><a href="map-licet.php" target="_blank">LICECT</a>
    ...
    <div>
        ...
        <ul>
            <li>Marongiu, Paola; Dell‘Oro, Francesca (2021). “<a
                        href="maps/map-licenter.php"
                        target="_blank">licenter</a>”. v.1.0. WoPoss. <a
                        href="https://woposs.unine.ch/maps/map-licenter.php">https://woposs.unine.ch/maps/map-licenter.php</a>
            </li>
        </ul>
    </div>
