...
<head>
    <title>Diachronic Visualisation: LICET - WoPoss</title>
    ...
    <script src="../js/json/licet.js">/**/</script>
...
<main>
    <h1>Diachronic modal semantic map of LICET</h1>

    <p>See related diachronic semantic maps:</p>
    <ul>
        <li><a href="map-licenter.php" target="_blank">LICENTER</a></li>
        <li><a href="map-licite-licet.php" target="_blank">LICITE</a></li>

        <li><a href="map-licito-licet.php" target="_blank">LICITO</a></li>
    ...
    <div>
        ...
        <div class="top">
            ...
            <ul>
                ...
                <li>Núñez, Salvador (1991). <em>Semántica de la modalidad en latín</em>. Granada: Universidad de
                    Granada.
                </li>
                <li>Magni, Elisabetta (2010). Mood and Modality. In P. Baldi & P. Cuzzolin (eds.), <em>New Perspectives
                        on
                        Historical Latin Syntax. Constituent Syntax: Adverbial Phrases, Adverbs, Mood, Tense</em> 2,
                    (pp.
                    193–275). Berlin: Mouton de Gruyter.
                </li>
        ...
        <ul>
            <li>Marongiu, Paola; Dell‘Oro, Francesca (2021). “<a
                        href="maps/map-licet.php"
                        target="_blank">licet</a>”. v.1.0. WoPoss. <a
                        href="https://woposs.unine.ch/maps/map-licet.php">https://woposs.unine.ch/maps/map-licet.php</a>
            </li>
        </ul>
    </div>
