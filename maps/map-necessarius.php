...
<head>
    <title>Diachronic Visualisation: NECESSARIUS - WoPoss</title>
    ...
    <script src="../js/json/necessarius.js">/**/</script>
...
<main>
    <h1>Diachronic modal semantic map of NECESSARIUS</h1>
    ...
    <div>
        ...
        <ul>
            <li>Marongiu, Paola; Dell‘Oro, Francesca (2021). “<a
                        href="maps/map-necessarius.php"
                        target="_blank">necessarius</a>”. v.1.0. WoPoss. <a
                        href="https://woposs.unine.ch/maps/map-necessarius.php">https://woposs.unine.ch/maps/map-necessarius.php</a>
            </li>
        </ul>
    </div>
