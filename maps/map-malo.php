...
<head>
    <title>Diachronic Visualisation: MALO - WoPoss</title>
    ...
    <script src="../js/json/malo.js">/**/</script>
...
<main>
    <h1>Diachronic modal semantic map of MALO</h1>
    ...
    <div>
        ...
        <ul>
            <li>Marongiu, Paola; Dell‘Oro, Francesca (2021). “<a
                        href="maps/map-malo.php"
                        target="_blank">malo</a>”. v.1.0. WoPoss. <a
                        href="https://woposs.unine.ch/maps/map-malo.php">https://woposs.unine.ch/maps/map-malo.php</a>
            </li>
        </ul>
    </div>
