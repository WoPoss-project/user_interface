...
<head>
    <title>Diachronic Visualisation: NEQUEO - WoPoss</title>
...
<main>
    <h1>Diachronic modal map of NEQUEO</h1>
    ...
    <div>
        ...
        <ul>
            <li>Marongiu, Paola; Dell‘Oro, Francesca (2021). “<a
                        href="maps/map-nequeo.php"
                        target="_blank">nequeo</a>”. v.1.0. WoPoss. <a
                        href="https://woposs.unine.ch/maps/map-nequeo.php">https://woposs.unine.ch/maps/map-nequeo.php</a>
            </li>
        </ul>
    </div>
