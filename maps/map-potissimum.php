...
<head>
    <title>Diachronic Visualisation: POTISSIMUM - WoPoss</title>
    ...
    <script src="../js/json/potissimum.js">/**/</script>
...
<main>
    <h1>Diachronic modal semantic map of POTISSIMUM</h1>

    <p>See related diachronic semantic maps:</p>
    <ul>
        <li><a href="map-pote.php" target="_blank">POTE</a></li>
        <li><a href="map-potes.php" target="_blank">POTES</a></li>
        <li><a href="map-potior.php" target="_blank">POTIOR</a></li>
        <li><a href="map-potis.php" target="_blank">POTIS</a></li>
        <li><a href="map-potissimus.php" target="_blank">POTISSIMUS</a></li>
        <li><a href="map-potius.php" target="_blank">POTIUS</a></li>
    </ul>
    ...
    <div>
        ...
        <ul>
            <li>Marongiu, Paola; Dell‘Oro, Francesca (2021). “<a
                        ...
                        target="_blank">potissimum</a>”. v.1.0. WoPoss. <a
                        href="https://woposs.unine.ch/maps/map-potissimum.php">https://woposs.unine.ch/maps/map-potissimum.php</a>
            </li>
        </ul>
    </div>
