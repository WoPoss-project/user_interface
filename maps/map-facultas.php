...
<head>
    <title>Diachronic Visualisation: FACULTAS - WoPoss</title>
    ...
    <script src="../js/json/facultas.js">/**/</script>
...
<main>
    <h1>Diachronic modal semantic map of FACULTAS</h1>
    ...
    <div>
        ...
        <ul>
            <li>Marongiu, Paola; Dell‘Oro, Francesca (2021). “<a
                        href="maps/map-facultas.php"
                        target="_blank">facultas</a>”. v.1.0. WoPoss. <a
                        href="https://woposs.unine.ch/maps/map-facultas.php">https://woposs.unine.ch/maps/map-facultas.php</a>
            </li>
        </ul>
    </div>
