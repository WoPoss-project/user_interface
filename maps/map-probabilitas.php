...
<head>
    <title>Diachronic Visualisation: PROBABILITAS - WoPoss</title>
    ...
    <div>
        ...
        <ul>
            <li>Marongiu, Paola; Dell‘Oro, Francesca (2021). “<a
                        href="maps/map-probabilitas.php"
                        target="_blank">probabilitas</a>”. v.1.0. WoPoss. <a
                        href="https://woposs.unine.ch/maps/map-probabilitas.php">https://woposs.unine.ch/maps/map-probabilitas.php</a>
            </li>
        </ul>
    </div>
