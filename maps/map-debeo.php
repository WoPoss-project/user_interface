...
<head>
    <title>Diachronic Visualisation: DEBEO - WoPoss</title>
    ...
    <script src="../js/json/debeo.js">/**/</script>
...
<main>
    <h1>Diachronic modal semantic map of DEBEO</h1>
    ...
    <div>
        ...
        <ul>
            <li>Marongiu, Paola; Dell‘Oro, Francesca (2021). “<a
                        ...
                        target="_blank">debeo</a>”. v.1.0. WoPoss. <a
                        href="https://woposs.unine.ch/maps/map-debeo.php">https://woposs.unine.ch/maps/map-debeo.php</a>
            </li>
        </ul>
    </div>
