...
<head>
    <title>Diachronic Visualisation: PROBABILIS - WoPoss</title>
    ...
    <script src="../js/json/probabilis.js">/**/</script>
...
<main>
    <h1>Diachronic modal semantic map of PROBABILIS</h1>

    <p>See related diachronic semantic map:</p>
    <ul>
        <li><a href="map-probabiliter.php" target="_blank">PROBABILITER</a></li>
    </ul>
    ...
    <div>
        ...
        <ul>
            <li>Marongiu, Paola; Dell‘Oro, Francesca (2021). “<a
                        href="maps/map-probabilis.php"
                        target="_blank">probabilis</a>”. v.1.0. WoPoss. <a
                        href="https://woposs.unine.ch/maps/map-probabilis.php">https://woposs.unine.ch/maps/map-probabilis.php</a>
            </li>
        </ul>
    </div>
