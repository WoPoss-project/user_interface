...
<head>
    <title>Diachronic Visualisation: APTUS - WoPoss</title>
    ...
    <script src="../js/json/aptus.js">/**/</script>
...
<main>
    <h1>Diachronic semantic map of APTUS</h1>
    <ul>
        <li><a href="map-apte.php" target="_blank">APTE</a></li>
    </ul>
    ...
    <div>
        ...
        <ul>
            <li>Marongiu, Paola; Dell‘Oro, Francesca (2021). “<a
                        href="maps/map-aptus.php"
                        target="_blank">aptus</a>”. v.1.0. WoPoss. <a
                        href="https://woposs.unine.ch/maps/map-aptus.php">https://woposs.unine.ch/maps/map-aptus.php</a>
            </li>
        </ul>
    </div>
