...
<head>
    <title>Diachronic Visualisation: INIQUITER - WoPoss</title>
    ...
    <script src="../js/json/iniquiter.js">/**/</script>
...
<main>
    <h1>Diachronic modal semantic map of INIQUITER</h1>
    ...
    <div>
        ...
        <ul>
            <li>Marongiu, Paola; Dell‘Oro, Francesca (2021). “<a
                        href="maps/map-iniquiter.php"
                        target="_blank">iniquiter</a>”. v.1.0. WoPoss. <a
                        href="https://woposs.unine.ch/maps/map-iniquiter.php">https://woposs.unine.ch/maps/map-iniquiter.php</a>
            </li>
        </ul>
    </div>
