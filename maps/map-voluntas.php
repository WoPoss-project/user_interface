...
<head>
    <title>Diachronic Visualisation: VOLUNTAS - WoPoss</title>
...
<main>
    <h1>Diachronic modal map of VOLUNTAS</h1>
    ...
    <div>
        ...
        <ul>
            <li>Marongiu, Paola; Dell‘Oro, Francesca (2021). “<a
                        href="maps/map-voluntas.php"
                        target="_blank">voluntas</a>”. v.1.0. WoPoss. <a
                        href="https://woposs.unine.ch/maps/map-voluntas.php">https://woposs.unine.ch/maps/map-voluntas.php</a>
            </li>
        </ul>
    </div>
