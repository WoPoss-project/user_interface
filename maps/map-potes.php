...
<head>
    <title>Diachronic Visualisation: POTES - WoPoss</title>
    ...
    <script src="../js/json/potes.js">/**/</script>
...
<main>
    <h1>Diachronic modal semantic map of POTES</h1>
    ...
    <div>
        ...
        <ul>
            <li>Marongiu, Paola; Dell‘Oro, Francesca (2021). “<a
                        ...
                        target="_blank">potes</a>”. v.1.0. WoPoss. <a
                        href="https://woposs.unine.ch/maps/map-potes.php">https://woposs.unine.ch/maps/map-potes.php</a>
            </li>
        </ul>
    </div>
