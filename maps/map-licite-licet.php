...
<head>
    <title>Diachronic Visualisation: LICITE - WoPoss</title>
    ...
    <script src="../js/json/licite_licet.js">/**/</script>
...
<main>
    <h1>Diachronic modal semantic map of LICITE</h1>

    <p>See related diachronic semantic maps:</p>
    <ul>
        <li><a href="map-licet.php" target="_blank">LICET</a>
    ...
    <div>
        ...
        <ul>
            <li>Marongiu, Paola; Dell‘Oro, Francesca (2021). “<a
                        href="maps/map-licite-licet.php"
                        target="_blank">licite</a>”. v.1.0. WoPoss. <a
                        href="https://woposs.unine.ch/maps/map-licite-licet.php">https://woposs.unine.ch/maps/map-licite-licet.php</a>
            </li>
        </ul>
    </div>
