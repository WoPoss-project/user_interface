...
<head>
    <title>Diachronic Visualisation: INCERTE - WoPoss</title>
...
<main>
    <h1>Diachronic modal map of INCERTE</h1>
    ...
    <div>
        ...
        <ul>
            <li>Marongiu, Paola; Dell‘Oro, Francesca (2021). “<a
                        ...
                        href="https://woposs.unine.ch/maps/map-incerte.php">https://woposs.unine.ch/maps/map-incerte.php</a>
            </li>
        </ul>
    </div>
