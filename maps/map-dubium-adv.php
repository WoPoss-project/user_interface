...
<head>
    <title>Diachronic Visualisation: DUBIUM (adv.) - WoPoss</title>
    ...
    <script src="../js/json/dubium_adv.js">/**/</script>
...
<main>
    <h1>Diachronic modal semantic map of DUBIUM (adverb)</h1>
    ...
    <div>
        ...
        <ul>
            <li>Marongiu, Paola; Dell‘Oro, Francesca (2021). “<a
                        href="maps/map-dubium-adv.php"
                        target="_blank">dubium</a> (adverb)”. v.1.0. WoPoss. <a
                        href="https://woposs.unine.ch/maps/map-dubium-adv.php">https://woposs.unine.ch/maps/map-dubium-adv.php</a>
            </li>
        </ul>
    </div>
