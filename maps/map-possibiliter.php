...
<head>
    <title>Diachronic Visualisation: POSSIBILITER - WoPoss</title>
    ...
    <script src="../js/json/possibiliter.js">/**/</script>
...
<main>
    ...
    <ul>
        <li><a href="map-possibilis.php" target="_blank">POSSIBILIS</a></li>
    </ul>
    ...
    <div>
        ...
        <ul>
            <li>Marongiu, Paola; Dell‘Oro, Francesca (2021). “<a
                        href="maps/map-possibiliter.php"
                        target="_blank">possibiliter</a>”. v.1.0. WoPoss. <a
                        href="https://woposs.unine.ch/maps/map-possibiliter.php">https://woposs.unine.ch/maps/map-possibiliter.php</a>
            </li>
        </ul>
    </div>
