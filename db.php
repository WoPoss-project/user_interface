    ...
    <body>
        ...
        <main>
            ...
            can have a glimpse of our annotation by visualizing Tertullian’s <em>De spectaculis</em> as annotated by Séverine Reymond and
                ...
                of the an automatic annotation of linguistic features and the manual annotation of modal passages. More metadata and corrections
                need to be added in following steps.</p>
            <p>Instructions:
            </p>
            <ol>
                ...
                <li>After logging in, go to the right upper corner and in “Import project files” select the file you downloaded in step 1 and click on “Upload selected files”.</li>
                <li>Once the project was correctly imported, pay attention to green pop-up stating the name of the uploaded project (as default the name is “copy_of_WoPoss” but if
