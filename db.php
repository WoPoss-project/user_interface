    ...
    <body>
        ...
        <main>
            ...
            <ol>
                ...
                <li>After logging in, go to the right upper corner and, in “Import project files”, select the file you downloaded in step 1 (a zip file). Then click on “Upload selected files”.</li>
                <li>Once the project was correctly imported, pay attention to green pop-up at the left bottom corner stating the name of the uploaded project (as default the name is “copy_of_WoPoss” but if
